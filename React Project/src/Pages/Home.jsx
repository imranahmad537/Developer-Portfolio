  ...
  <div className="bg-[#f8f9ff] text-black text-[15px]">
    <header className='py-4 px-4 sm:px-10 z-50 min-h-[70px]'>
      <div className='relative flex flex-wrap items-center gap-4'>
        <a href="javascript:void(0)"><img src="https://readymadeui.com/readymadeui.svg" alt="logo" classNameName='w-36' />
        </a>
          ...
          <ul
            ...
            <li className='max-lg:border-b max-lg:py-3 px-3'>
              <a href='javascript:void(0)'
                className='hover:text-blue-600 text-blue-600 block font-semibold transition-all'>Home</a>
            </li>
            <li className='max-lg:border-b max-lg:py-3 px-3'><a href='javascript:void(0)'
                className='hover:text-blue-600 block font-semibold transition-all'>Team</a>
            </li>
            <li className='max-lg:border-b max-lg:py-3 px-3'><a href='javascript:void(0)'
                className='hover:text-blue-600 block font-semibold transition-all'>Feature</a>
            </li>
            <li className='max-lg:border-b max-lg:py-3 px-3'><a href='javascript:void(0)'
                className='hover:text-blue-600 block font-semibold transition-all'>Blog</a>
            </li>
            <li className='max-lg:border-b max-lg:py-3 px-3'><a href='javascript:void(0)'
    ...
    <div className="px-4 sm:px-10">
      ...
      <div className="mt-32">
        ...
        <div className="grid md:grid-cols-3 md:py-16 gap-8 max-w-7xl max-md:max-w-lg mx-auto relative">
          <div
            className="bg-blue-100 lg:max-w-[70%] max-w-[80%] h-full w-full inset-0 mx-auto rounded-3xl absolute max-md:hidden">
          </div>
          <div className="h-auto lg:p-6 p-4 rounded-md mx-auto bg-white relative max-md:shadow-md">
            <div>
              ...
              <h4 className="whitespace-nowrap font-semibold mt-2">John Doe</h4>
          ...
          <div className="h-auto lg:p-6 p-4 rounded-md mx-auto bg-white relative max-md:shadow-md">
            <div>
              ...
              <h4 className="whitespace-nowrap font-semibold mt-2">Mark Adair</h4>
          ...
          <div className="h-auto lg:p-6 p-4 rounded-md mx-auto bg-white relative max-md:shadow-md">
            <div>
              ...
              <h4 className="whitespace-nowrap font-semibold mt-2">Simon Konecki</h4>
        ...
        <div className="grid lg:grid-cols-3 md:grid-cols-2 gap-8 mt-16 max-md:max-w-lg max-md:mx-auto">
          <div className="bg-white rounded sm:p-6 p-4">
            ...
            <div className="mt-6">
              ...
              <button type="button"
                className="w-full mt-6 px-6 py-3 rounded-xl text-white bg-cyan-900 transition-all hover:bg-cyan-800">Get
                Started</button>
            </div>
            <div className="mt-6">
        ...
        <div className="grid sm:grid-cols-2 items-center gap-16 my-6 mx-auto max-w-5xl">
          ...
          <form className="ml-auo space-y-4">
            ...
            <textarea placeholder='Message' rows="6"
              className="w-full rounded-md px-4 bg-[#f8f9ff] pt-3 outline-cyan-900"></textarea>
            <button type='button'
              className="w-full mt-6 px-6 py-3 rounded-xl text-white bg-cyan-900 transition-all hover:bg-cyan-800">Send</button>
          </form>
        </div>
      </div>
    ...
    <footer className="bg-white px-4 sm:px-10 py-12 mt-32">
      <div className="grid max-sm:grid-cols-1 max-lg:grid-cols-2 lg:grid-cols-5 lg:gap-14 max-lg:gap-8">
        ...
        <div>
          ...
          <ul className="space-y-5">
            <li><a href="javascript:void(0)" className="hover:text-blue-600">Web
                Development</a></li>
            <li><a href="javascript:void(0)" className="hover:text-blue-600">Mobile App
                Development</a></li>
            <li><a href="javascript:void(0)" className="hover:text-blue-600">UI/UX
                Design</a></li>
            <li><a href="javascript:void(0)" className="hover:text-blue-600">Digital Marketing</a></li>
          </ul>
        </div>
        ...
        <div>
          ...
          <ul className="space-y-5">
            <li><a href="javascript:void(0)" className="hover:text-blue-600">Webinars</a>
            </li>
            <li><a href="javascript:void(0)" className="hover:text-blue-600">Ebooks</a>
            </li>
            <li><a href="javascript:void(0)" className="hover:text-blue-600">Templates</a>
            </li>
            <li><a href="javascript:void(0)" className="hover:text-blue-600">Tutorials</a></li>
          </ul>
        </div>
        ...
        <div>
          <h4 className="text-xl font-semibold mb-6">About Us</h4>
          <ul className="space-y-5">
            <li><a href="javascript:void(0)" className="hover:text-blue-600">Our Story</a>
            </li>
            <li><a href="javascript:void(0)" className="hover:text-blue-600">Mission and
                Values</a></li>
            <li><a href="javascript:void(0)" className="hover:text-blue-600">Team</a></li>
            <li><a href="javascript:void(0)" className="hover:text-blue-600">Testimonials</a></li>
          </ul>
        </div>
      </div>
